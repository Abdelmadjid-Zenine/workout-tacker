...
import BodyData from "../HumanBody/BodyInfoForm/BodyInfoForm"
...
class HumanBody extends Component {
    ...
    toggleForm = (e) => {
        ...
        this.setState({bodyPart:e.currentTarget.className.baseVal, showForm:true})        
    }
    hideFormHandler = () => {
